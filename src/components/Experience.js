  ...
  return (
    <div className=' bg-black p-12 rounded-lg border'>
       ...
       <li className='mb-10 ms-6'>
            ...
            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white sm:text-xl md:text-2xl">Medi-connect</h3>
            ...
            <li className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Ensure consistent design elements (colors, fonts, button styles) across all pages.</li>
            <li className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Use Git for version control, ensuring proper commit messages that reflect changes made to UI and functionalities.</li>
            <li className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Implement responsive layouts using CSS frameworks(Sass,bootstrap)
            </li>
            </ul>
